...
typedef enum {
    NMNotificationDrafted,
    NMNotificationSending,
    NMNotificationFinished,
    NMNotificationFailed
} NMNotificationStatus;

typedef enum {
    NMNotificationPushPlatformIOS,
    NMNotificationPushPlatformAndroid,
    NMNotificationPushPlatformWP
} NMNotificationPushPlatform;
