 ...
 * Default value is nil. If this value is nil when calling +registerWithDeviceDetail:completionHandler: method, 
 * existing customDictionary does not overridden. Else, existing customDictionary value is overridden with given 
 * dictionary.
 */
...
/**
 * Returns the tags that are set to the NMDeviceDetail object via addTag: , addTags: or overrideTagsWithNewTags: method.
 * It DOES NOT return actual tags of the device. In order to get actual tags registered by device, use +getDeviceDetailWithCompletionHandler: method.
 */
- (NSArray *)getTags;
