...
{
//    UIAlertView *message = [[UIAlertView alloc] initWithTitle:@"خطأ في الاتصال بالإنترنت ، رجاء التحقق من الإتصال بالإنترنت الخاص بك" message:nil delegate:nil cancelButtonTitle:@"موافق" otherButtonTitles:nil,nil];
//    [message show];
    [self.activityIndicator stopAnimating];
}
